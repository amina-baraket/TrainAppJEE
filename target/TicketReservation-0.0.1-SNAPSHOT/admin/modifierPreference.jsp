...
<body>
    <div class="container mt-4">
        <h2>Modifier une Préférence</h2>
        
        <c:if test="${not empty error}">
            <div class="alert alert-danger">${error}</div>
        </c:if>
        
        <form action="${pageContext.request.contextPath}/admin/preferences/modifier" method="post" class="mt-4">
            ...
            <div class="mb-3">
                ...
                <a href="${pageContext.request.contextPath}/admin/preferences/liste" class="btn btn-secondary">
                    Annuler
                </a>
            </div>
        </form>
