...
<body>
    <div class="main-container">
        <h2 class="page-title-admin">Ajouter un Voyage Consécutif</h2>
        
        <c:if test="${not empty error}">
            <div class="alert alert-danger">${error}</div>
        </c:if>
        
        <form action="${pageContext.request.contextPath}/admin/voyages-consecutifs/ajouter" method="post" class="admin-form mt-4">
            <div class="mb-3">
